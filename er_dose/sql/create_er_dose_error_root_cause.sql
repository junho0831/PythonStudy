...
create table if not exists prism_common.er_dose_error_root_cause (
    er_line                 varchar(20),
    eq_name                 varchar(20),
    er_type                 varchar(10),
    code                    varchar(20),
...
on prism_common.er_dose_error_root_cause (er_line, eq_name, code_occur_time);

comment on table prism_common.er_dose_error_root_cause is
