...
class FakeDB:
    ...
    def select(self, query, params=None, connection=None):
...
class ERDoseProcessorTest(unittest.TestCase):
    ...
    def test_fetch_counts_filter_active_nxe_eq_names(self):
        ...
        self.assertEqual(equipment_counts, {"source_count": 1, "target_count": 1, "matched": True, "equipment_counts": [{"eq_name": "EQ1", "source_count": 1, "target_count": 1}]})
    ...
    def test_run_processes_multiple_chunks(self):
        ...
        self.assertTrue(all(option["analyze"] for option in db.copy_options))
    ...
    def test_run_writes_equipment_counts_to_common_log(self):
        ...
        params = next(params for _, params, _ in log_queries if params["batch_name"] == "ER_DOSE_RAW")
